...
**Important:** do not use parallel::detectCores() on Roihu or in other HPC systems - it always returns the maximum number of cores in a node (384 in Roihu), no matter how many have been reserved. This causes problems!
