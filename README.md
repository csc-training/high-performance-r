...
Lecture slides (2026):  
[https://a3s.fi/high-performance-r/index.html](https://a3s.fi/high-performance-r/index.html)
...
The topics are covered using short lectures and/or demonstrations followed by hands-on exercises using RStudio and batch jobs on the supercomputer Roihu.
...
- Useful to make the most of the course content but not required:
  - Basics of Linux
  - Some experience in using a supercomputer, for example using the RStudio in the Puhti/Roihu web interface or the course CSC Computing Environment, Part 1: Basics
